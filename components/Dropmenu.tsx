...
import { Button, NativeSyntheticEvent, Text, TextInput, TextInputChangeEventData, TextInputSubmitEditingEventData, View } from 'react-native';
...
placeholder = "$ 0.00"
placeholderTextColor = "#808080"
onChange={(e: NativeSyntheticEvent<TextInputChangeEventData>) => this.cost = parseInt(e.nativeEvent.text)}
returnKeyType= 'done'
/>
<Button
